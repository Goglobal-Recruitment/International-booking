...
<body class="min-h-screen bg-white">
        ...
        <div class="container">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <button class="btn btn-outline btn-sm" onclick="openModal('register')">
                            Register
                        </button>
                        <button class="btn btn-primary btn-sm" onclick="openModal('login')">
                            Sign in
                        </button>
                    </div>
            ...
            <div class="border-t border-blue-700">
                <nav class="flex items-center">
                    <a href="#" class="nav-item active" onclick="setActiveTab(event, 'stays')">
                        <span class="icon">🏨</span>
                        <span>Stays</span>
                    </a>
                    <a href="flights.html" class="nav-item" onclick="setActiveTab(event, 'flights')">
                        <span class="icon">✈️</span>
                        <span>Flights</span>
                    </a>
                    <a href="#" class="nav-item" onclick="setActiveTab(event, 'cars')">
                        <span class="icon">🚗</span>
                        <span>Car rental</span>
                    </a>
                    <a href="#" class="nav-item" onclick="setActiveTab(event, 'attractions')">
                        <span class="icon">⭐</span>
                        <span>Attractions</span>
                    </a>
                    <a href="#" class="nav-item" onclick="setActiveTab(event, 'taxis')">
                        <span class="icon">🚕</span>
            ...
            <div id="mobileMenu" class="mobile-menu desktop-hidden">
                <nav class="flex flex-col space-y-2">
                    <a href="#" class="mobile-menu-item">🏨 Stays</a>
                    <a href="flights.html" class="mobile-menu-item">✈️ Flights</a>
                    <a href="#" class="mobile-menu-item">🚗 Car rental</a>
                    <a href="#" class="mobile-menu-item">⭐ Attractions</a>
                    <a href="#" class="mobile-menu-item">🚕 Airport taxis</a>
                </nav>
            </div>
        </div>
    </header>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="search-form">
                <div class="grid grid-cols-1 lg-grid-cols-4 gap-4 mb-6">
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-input form-input-icon" placeholder="Destination" value="">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="input-group">
                            <span class="input-icon">📅</span>
                            <input type="date" class="form-input form-input-icon" value="">
                        </div>
                    </div>
                    <div>
                ...
                <div class="flex justify-end">
                    <button class="btn btn-primary btn-lg" onclick="searchProperties()">
                        <span class="icon mr-2">🔍</span> Search
                    </button>
                </div>
            </div>
        </div>
    ...
    <!-- Search Results -->
    <div id="searchResults" class="container px-4 py-8" style="display: none;">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-2xl mb-6">Search Results</h2>
            <div class="grid grid-cols-1 md-grid-cols-2 lg-grid-cols-3 gap-6">
                <!-- Property Cards (example 3) -->
                <div class="card hover-shadow-lg transition-shadow">
                    <div class="relative h-48">
                        <img src="images/luxury-resort.jpg" alt="Luxury Resort & Spa" class="property-image">
                        <span class="badge bg-green-600 absolute top-2 right-2">Hotel</span>
                    </div>
                    <div class="card-header">
                        <div class="flex items-start justify-between">
                            <h3 class="text-lg">Luxury Resort & Spa</h3>
                        ...
                        <div class="flex items-center text-gray-600 text-sm">
                            <span class="icon mr-1">📍</span> Cape Town, South Africa
                        </div>
                    </div>
                    <div class="card-content">
                        <p class="text-gray-600 text-sm mb-4">5-star resort with ocean view</p>
                        <div class="flex items-center justify-between">
                            <div class="text-right">
                                <div class="price-display">ZAR 299</div>
                                <div class="price-period">per night</div>
                            </div>
                            <button class="btn btn-primary" onclick="selectBooking('stays')">Book now</button>
                        </div>
                    </div>
                </div>
                <!-- You can add the other two property cards here -->
            </div>
        </div>
    </div>
        ...
        <div class="container py-12">
            <div class="grid grid-cols-1 md-grid-cols-2 lg-grid-cols-5 gap-8">
                ...
                <div>
                    <h4>About</h4>
                    <ul class="space-y-2">
                        <li><a href="#">About Booking International</a></li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-center text-sm">
                    ...
                    <a href="#" onclick="openModal('register')" class="text-blue-600">Register here</a>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-center text-sm">
                    ...
                    <a href="#" onclick="openModal('login')" class="text-blue-600">Sign in here</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function selectBooking(type) {
            alert('Booking functionality would be available in the full application. Please sign in to continue.');
        }
